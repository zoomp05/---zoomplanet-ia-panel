...
import Chat from "../chat/Chat";import { Switch } from "antd";
...
import "./css/ProjectIAFlow.css";


const ProjectIAFlow = ({ defaultProjectId }) => {
  // Obtener ID de la ruta o usar el proporcionado como prop
  ...
  // Solo ejecutar la consulta si tenemos un projectId
  const { data, loading, error, refetch } = useQuery(GET_PROJECT, {
    variables: { id: projectId },
    skip: !projectId, // Omitir la consulta si no hay ID
  });
  ...
  // Mostrar un mensaje si no hay proyecto seleccionado
  if (!projectId) {
    return (
      <div className="project-empty-state">
        <h3>Selecciona un proyecto para comenzar</h3>
        <p>Puedes crear un nuevo proyecto o seleccionar uno existente de la lista.</p>
      </div>
    );
  }
